...
class Combine:
    ...
    def generate_dataframes(self):
        ...
        # for i in range(len(self.order_df.index)):
        #     if i % 2 == 1:
        #         if self.order_df.iloc[i,'Signal'] == 'SELL':
        #             self.percent_change.append(self.order_df.iloc[i,'Price'] - self.order_df.iloc[i-1,'Price']/self.order_df.iloc[i-1,'Price']*100)
        #         else:
        #             self.percent_change.append(self.order_df.iloc[i-1,'Price'] - self.order_df.iloc[i,'Price']/self.order_df.iloc[i,'Price']*100)
        #     else :
        #         self.percent_change.append(0)
        # self.order_df['%change'] = self.percent_change
